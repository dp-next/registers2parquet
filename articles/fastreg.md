...
#> ✔ Converted 'kontakter_2020.sas7bdat'
```
...
kontakter_sas_files
#> /tmp/Rtmp4WhTq3/sas-dir/kontakter/kontakter_1999_1.sas7bdat
#> /tmp/Rtmp4WhTq3/sas-dir/kontakter/kontakter_1999_2.sas7bdat
#> /tmp/Rtmp4WhTq3/sas-dir/kontakter/kontakter_2020.sas7bdat
#> /tmp/Rtmp4WhTq3/sas-dir/kontakter/kontakter.sas7bdat
```
...
#> ✔ Converted 'kontakter_1999_1.sas7bdat'
#> ✔ Converted 'kontakter_1999_2.sas7bdat'
#> ✔ Converted 'kontakter_2020.sas7bdat'
...
#> • Output: Register files in '/tmp/Rtmp4WhTq3/output-register-dir/kontakter'
```
...
but that can be adjusted in the pipeline, the `_targets.R` file, to fit
...
#> ✔ Created '/tmp/Rtmp4WhTq3/pipeline-dir/_targets.R'
...
#>  1 108684730664 9201662543457744… 20170316   Fysio- og ergote… /tmp/Rtmp4…  1999
#>  2 982144017357 0759727820625697… 20081030   Thoraxkirurgi     /tmp/Rtmp4…  1999
#>  3 672580814975 1765362830036030… 19781226   Klinisk immunolo… /tmp/Rtmp4…  1999
#>  4 439008110445 5816242949650462… 20040706   Akut medicin      /tmp/Rtmp4…  1999
#>  5 489714666740 8142102823445808… 20160613   Karkirurgi        /tmp/Rtmp4…  1999
#>  6 155331797020 3938857359733134… 20001231   Nefrologi         /tmp/Rtmp4…  1999
#>  7 777951655096 8361795065466867… 20250325   Diagnostisk radi… /tmp/Rtmp4…  1999
#>  8 167007504860 8141754368465387… 19961124   Pædiatri          /tmp/Rtmp4…  1999
#>  9 132473802596 5081335938814873… 19970403   Klinisk immunolo… /tmp/Rtmp4…  1999
#> 10 876820784981 3250770638911327… 19990709   Geriatri          /tmp/Rtmp4…  1999
#> # ℹ more rows
```
