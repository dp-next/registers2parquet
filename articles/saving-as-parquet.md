# Saving the SAS databases in Parquet format

Based on the title, I’m taking the SAS database and converting it into
the Parquet format. So… what is Parquet and why did I decide to use that
instead of using the standard “import the SAS data into R and use it as
normal there”? This document is meant to be used as an explanation and
description for the reasons and than later will show the code used to
