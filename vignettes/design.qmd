...
| `output_path` | An absolute path to the directory where the Parquet file should be created in. |
| `path` | An absolute path to a file or directory. Can be a single path or multiple paths as a character vector. Is used in functions to list available files or to specify input files. |
