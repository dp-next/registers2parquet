...
#'
#' @param input_path A character vector with the path to the register SAS file(s).
...
#' @examples
#' \dontrun{
#' convert_register_to_parquet(c("bef2018.sas7bdat",
#'      "bef2019.sas7bdat",
#'      "Demember2023bef2019.sas7bdat"), "output_directory/")
#' }
