...
| `output_path` | A path to the directory where the Parquet file should be created in. |
| `path` | A path to a file or directory. Can be a single path or multiple paths as a character vector. Is used in functions to list available files or to specify input files. |
